    ...
    return (
        <div className="my-10 w-full  flex flex-col lg:flex-row items-center justify-center gap-10 p-2  bg-blue-100 rounded-2xl">
            ...
            <div className="flex flex-col items-center gap-4 text-center">
                ...
                <Link to="/product-details/67c04d6454b6ce837a9b566e" className="bg-orange-500 flex items-center gap-2 px-8 py-2 rounded-md text-white font-medium group">Buy now
